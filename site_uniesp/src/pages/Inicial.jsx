...
//                 A Faculdade UNIESP é uma instituição comprometida em fornecer educação de qualidade, com foco no desenvolvimento 
//                 profissional e pessoal dos alunos. Nossos cursos são projetados para atender às demandas do mercado de trabalho 
//                 e preparar nossos alunos para os desafios da vida profissional.
//                 </Typography>
...
//                     <Paper elevation={3} sx={{p: 3 , backgroundColor: '#FFF', borderRadius: '8px'}} >
//                         {/* <Typography variant='h5' gutterBottom>
//                             Noticias
//                         </Typography>

//                         <Typography variant='body1'>
//                             Fique atualizado com as ultimas noticias.
//                         </Typography> */}
...
//                 <Grid item xs={12} md={6}>
//                     <Paper elevation={3} sx={{p: 3 , backgroundColor: '#FFF', borderRadius: '8px', textAlign: 'center'}} >
//                         {/* <Typography variant='h5' gutterBottom>
//                             Area administrativa
//                         </Typography>
